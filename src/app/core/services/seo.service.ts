...
export class SeoService {
  ...
  readonly #copy: Record<LocaleCode, SeoCopy> = {
    en: {
      ...
      description: $localize`:@@seo.desc:Tech Lead / Senior Angular Developer. 14+ years of commercial experience, 11+ on Angular (v2 → v22), across every platform — Web (SSR), Smart TV, Mobile (Ionic), Desktop (Tauri/Rust). Zoneless, signals, Nx monorepos, OpenAPI/zod codegen, design systems, GitLab CI/CD, 89–100% test coverage, 70+ technical interviews, AI code-review. Remote only.`,
    },
    ru: {
      title: $localize`:@@seo.title:Alexey Popov — Tech Lead / Senior Angular Developer`,
      description: $localize`:@@seo.desc:Tech Lead / Senior Angular Developer. 14+ years of commercial experience, 11+ on Angular (v2 → v22), across every platform — Web (SSR), Smart TV, Mobile (Ionic), Desktop (Tauri/Rust). Zoneless, signals, Nx monorepos, OpenAPI/zod codegen, design systems, GitLab CI/CD, 89–100% test coverage, 70+ technical interviews, AI code-review. Remote only.`,
