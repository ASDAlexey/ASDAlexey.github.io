    ...
    var DrumIcon = (function () {
        ...
        return {
            up: function (settings) {
                ...
                $(p)
                    .attr("d", "m0," + (height + settings.dail_stroke_width) + "l" + (width / 2) + ",-" + height + "l" + (width / 2) + "," + height);
                $(svg).find("g").append(p);
            ...
            down: function (settings) {
                ...
                $(p)
                    .attr("d", "m0,-" + settings.dail_stroke_width + "l" + (width / 2) + "," + height + "l" + (width / 2) + ",-" + height);
                $(svg).find("g").append(p);
    ...
    var Drum = function (element, options, transformProp) {
        ...
        if (settings.transformProp) {
            ...
            var transform = function (fire_event) {
                $(drum)
                    .css(settings.transformProp, 'translateZ(-' + settings.radius + 'px) ' + settings.rotateFn + '(' + settings.rotation + 'deg)');
